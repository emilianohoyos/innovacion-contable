            ...
            <div class="card-body p-4">
                <form class="row g-3" id="formEmployee">
                    <div class="col-md-6">
                        ...
                        <select name="document_type_id" class="form-control" id="document_type_id" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="job_title" class="form-control" id="job_title" required>
                    ...
                    <div class="col-md-4">
                        <label for="emergency_contact_address" class="form-label">Dirección del contacto de
                            emergencia</label>
                        <input type="emergency_contact_address" class="form-control" id="emergency_contact_address"
                            name="emergency_contact_address" placeholder="Ingrese dirección">
                    </div>
