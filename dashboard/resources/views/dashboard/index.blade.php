                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start justify-content-around bg-light p-3 rounded-3 mt-3">
                        <div class="">
                            ...
                            <p class="mb-0"><span class="text-success me-2 fw-medium">16.5%</span><span>55.21 USD</span>
                            </p>
                        </div>
                        <div class="vr"></div>
                        <div class="">
                        ...
                        <div class="d-flex flex-column gap-4">
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/11.png') }}" width="30"
                                        alt="">
                                </div>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/10.png') }}" width="30"
                                        alt="">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/13.png') }}" width="30"
                                        alt="">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/01.png') }}" width="30"
                                        alt="">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/02.png') }}" width="30"
                                        alt="">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/06.png') }}" width="30"
                                        alt="">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                                    <img src="{{ URL::asset('build/images/apps/04.png') }}" width="30"
                                        alt="">
                                </div>
                                <div class="flex-grow-1">
        ...
        <div class="col-12 col-xl-4 d-flex">
            <div class="card w-100 rounded-4">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column gap-3">
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/01.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/02.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/03.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/04.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/05.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/06.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ URL::asset('build/images/top-products/07.png') }}" width="55"
                                alt="">
                            <div class="flex-grow-1">
