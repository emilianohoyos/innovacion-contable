                    ...
                    <div class="row gy-2 gx-0 my-4">
                        <div class="col-12 col-lg-12">
                            <button
                                ...
                                <span class="auth-social-login"><img src="{{ URL::asset('dist/images/apps/05.png') }}"
                        ...
                        <div class="col-12 col-lg-12">
                            <button
                                class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                                <span class="auth-social-login"><img src="{{ URL::asset('dist/images/apps/17.png') }}"
                        ...
                        <div class="col-12 col-lg-12">
                            <button
                                class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                                <span class="auth-social-login"><img src="{{ URL::asset('dist/images/apps/18.png') }}"
