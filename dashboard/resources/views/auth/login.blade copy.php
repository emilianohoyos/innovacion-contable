                    ...
                    <div class="row gy-2 gx-0 my-4">
                        <div class="col-12 col-lg-12">
                            <button
                                ...
                                <span class="auth-social-login"><img src="{{ URL::asset('build/images/apps/05.png') }}"
                                        width="20" class="me-2" alt="">Google</span>
                            </button>
                        </div>
                        <div class="col-12 col-lg-12">
                            <button
                                class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                                <span class="auth-social-login"><img src="{{ URL::asset('build/images/apps/17.png') }}"
                                        width="20" class="me-2" alt="">Facebook</span>
                            </button>
                        </div>
                        <div class="col-12 col-lg-12">
                            <button
                                class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                                <span class="auth-social-login"><img src="{{ URL::asset('build/images/apps/18.png') }}"
                                        width="20" class="me-2" alt="">LinkedIn</span>
                            </button>
                        </div>
                    </div>
                        ...
                        <form class="row g-3" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="inputEmailAddress" name="email" value="admin@gmail.com"
