...
<x-page-title title="Cards" pagetitle="Basic" />
        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('dist/images/gallery/01.png') }}" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('dist/images/gallery/02.png') }}" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Stay at home</h5>
                <p class="card-text">Nam libero tempore, cum soluta nobis est
                  eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas
          ...
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('dist/images/gallery/03.png') }}" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Stay at home</h5>
                <p class="card-text">Nam libero tempore, cum soluta nobis est
                  eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas
          ...
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('dist/images/gallery/04.png') }}" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Stay at home</h5>
                <p class="card-text">Nam libero tempore, cum soluta nobis est
                  eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas
          ...
          <div class="col">
            <div class="card">
              <div class="card-body">
                <img src="{{ URL::asset('dist/images/gallery/05.png') }}" class="w-100 mb-4 rounded" alt="...">
          ...
          <div class="col">
            <div class="card">
              <div class="card-body">
                <img src="{{ URL::asset('dist/images/gallery/06.png') }}" class="w-100 mb-4 rounded" alt="...">
                <h5 class="card-title mb-4">Why do we use it?</h5>
                <p class="card-text mb-4">Many desktop publishing packages and web page editors now use Lorem Ipsum.</p>
          ...
          <div class="col">
            <div class="card">
              <div class="card-body">
                <img src="{{ URL::asset('dist/images/gallery/07.png') }}" class="w-100 mb-4 rounded" alt="...">
                <h5 class="card-title mb-4">Why do we use it?</h5>
                <p class="card-text mb-4">Many desktop publishing packages and web page editors now use Lorem Ipsum.</p>
          ...
          <div class="col">
            <div class="card">
              <div class="card-body">
                <img src="{{ URL::asset('dist/images/gallery/08.png') }}" class="w-100 mb-4 rounded" alt="...">
                <h5 class="card-title mb-4">Why do we use it?</h5>
                <p class="card-text mb-4">Many desktop publishing packages and web page editors now use Lorem Ipsum.</p>
