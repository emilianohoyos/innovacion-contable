...
class ClientResponsible extends Model
{
    ...
    protected $casts = [
        'industry_commerce_places' => 'json',
        'industry_commerce_retainer_places' => 'json',
        'industry_commerce_selfretaining_places' => 'json',
        'municipal_exogenous_information_places' => 'json',
        'single_registry_proposers_places' => 'json',
